...
namespace Forever_Home_Finder.Models
{
    ...
    {
        public const string PetType = "type-";
    ...
    public class RouteDictionary : Dictionary<string, string>
    {
        ...
        public string /*Genre*/PetTypeFilter
        {
            get => Get(nameof(PetsGridDTO.PetType))?.Replace(FilterPrefix.PetType, "");
            set => this[nameof(PetsGridDTO.PetType)] = value;
        }

        public void ClearFilters() =>
            PetTypeFilter = PetsGridDTO.DefaultFilter;
